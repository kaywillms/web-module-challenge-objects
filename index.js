...
createMenuItem("Cheese", 20, "Snack")
...
function getLastReview(obj) {
   obj[9].feedback = "this place is chill with really cool people, great for getting work done on weekdays";

  return `${obj[9].name} gave the restaurant a ${obj[9].rating}, and their feedback was: ${obj[9].feedback}`
}
